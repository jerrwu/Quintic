...
class MoodEntity(var id: Int, var icOutline: Int, var icFilled: Int, var color: Int) {
    companion object {
        ...
        val GOOD = MoodEntity(4, R.drawable.ic_happy_outline, R.drawable.ic_happy, R.color.green)
        val VERY_GOOD = MoodEntity(5, R.drawable.ic_excited_outline, R.drawable.ic_excited, R.color.blue)
